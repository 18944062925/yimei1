    ...
    oTableInit.Init = function () {
        $('#MedicalRecord').bootstrapTable({
            ...
            responseHandler: function (res) {
                ...
                if (res.code === 1) {
                    if(res.message!="没有查到对应的数据！"&&res.message!=""){
...
function addFunctionAlty(value, row, index){
    console.log('addFunctionAlty',row);
        ...
        $.ajax({
            ...
            success: function (da) {
                ...
                if (da !== null && da.code == 0) {
                    ...
                    if (data.examination_cost===null){
                        $("#total").val(data.money)
                    }else {
                        $("#total").val(data.money+data.examination_cost)
                    }
                }
            }
        })
